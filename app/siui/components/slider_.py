...
from app.siui.components.container import SiDenseContainer
from app.siui.components.graphic import SiAnimatedTransformGraphicProxyWidget
from app.siui.components.label import SiLinearIndicator
...
class SiWheelPickerHorizontal(SiDenseContainer):
    ...
    def _initStyle(self):
        ...
        self._title_label.setStyleSheet(
            # "background-color: red;"
            "color: #918497;padding-bottom: 3px;"
        )
...
class SiScrollAreaRefactor(QScrollArea):
    ...
    def _initScrollBar(self) -> None:
        ...
        self.scrollbar_v.setStyleSheet(
            "QScrollBar:vertical {    border: none;    width: 8px;    margin: 0px 0px 0px 0px;}"
        )
        ...
        self.scrollbar_h.setStyleSheet(
            "QScrollBar:horizontal {    border: none;    height: 8px;    margin: 0px 0px 0px 0px;}"
        )
