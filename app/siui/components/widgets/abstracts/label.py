...
from app.siui.core import Si, SiAnimationGroup, SiColor, SiExpAnimation, SiGlobal, SiQuickEffect
        ...
        if self.hint != "" and "TOOL_TIP" in SiGlobal.siui.windows:
            if SiGlobal.siui.windows["TOOL_TIP"].nowInsideOf() == self:  # 如果鼠标正在该控件内
                SiGlobal.siui.windows["TOOL_TIP"].setText(
                    self.hint, flash=self.isSiliconWidgetFlagOn(Si.FlashOnHintUpdated)
                )
