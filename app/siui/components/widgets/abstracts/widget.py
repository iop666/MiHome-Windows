...
from app.siui.core import Si, SiAnimationGroup, SiColor, SiExpAnimation, SiGlobal
from app.siui.gui.color_group import SiColorGroup
...
class SiWidget(QWidget):
    ...
    def setSiliconWidgetFlag(self, flag, on: bool = True):
        """
    ...
    def setCenterWidget(self, widget):
        ...
        if widget is not None:
            ...
            self.center_widget.move(
                (self.width() - self.center_widget.width()) // 2, (self.height() - self.center_widget.height()) // 2
            )
    ...
    def paintEvent(self, event):
        ...
        self.center_widget.render(pixmap)  # render all its children
