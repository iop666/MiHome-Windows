...
from app.core.models import DeviceInfo, enum_option_text, unit_suffix
...
class QuickOpsPopup(QFrame):
    ...
    def _make_slider_row(self, op, val_label: QLabel) -> QSlider:
        ...
        self._sliders[op.name] = (slider, val_label, scale, suffix)
        return slider
    ...
    def update_value(self, name: str, value) -> None:
        ...
        if sl is not None:
            ...
            label.setText(f"{float(value) / scale:g}{suffix}")
